    ...
    return (
        <div className=" flex flex-col gap-2 items-center justify-center bg-transparent h-[100vh] w-[100vw]">
            ...
            <div className="border p-4 border-orange-500 w-[350px] flex flex-col h-fit rounded-md">
                ...
                <button className="w-full h-40px bg-transparent border border-white rounded-md p-2 flex flex-row gap-2 justify-center" onClick={() => }><FaGithub size={25}/>SignIn with Github</button>
            </div>
