export default function SignupPage() {
    return (
        <div className=" flex flex-col gap-2 items-center justify-center bg-transparent h-[100vh] w-[100vw]">
            <h1>Sign-up here</h1>
            <div className="border p-4 border-orange-500 w-[350px] flex flex-col h-[400px] rounded-md">
                ...
                <button className="w-full h-40px bg-orange-500 rounded p-2 mt-4" >Signup</button> 
            </div>
        </div>
    )
}