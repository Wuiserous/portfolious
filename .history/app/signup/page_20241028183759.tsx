    ...
    return (
        <div className=" flex flex-col gap-2 items-center justify-center bg-transparent h-[100vh] w-[100vw]">
            ...
            <div className="border p-4 border-orange-500 w-[350px] h-[400px] rounded-md">
                <label htmlFor="usernamel" className="text-orange-500">Username</label>
                <input type="text" id='username' value='email' className="border-none rounded-md w-full h-[40px] text-white " />  
