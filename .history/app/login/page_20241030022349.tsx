    ...
    return (
        <div className=" flex flex-col gap-2 items-center justify-center bg-transparent h-[100vh] w-[100vw]">
            ...
            <div className="border border-orange-500 w-[350px] h-fit rounded-md p-2">
                ...
                <button className="w-full h-40px bg-transparent border border-white rounded-md p-2 flex flex-row gap-2 justify-center" onClick={() => signIn()}><FaGithub size={25}/>LogIn with Github</button>
            </div>
