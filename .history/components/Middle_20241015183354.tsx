...
export default function Middle() {
    ...
    return (
        <div className="w-[50%] h-[100vh] overflow-y-scroll flex bg-orange-500 flex-col gap-2 p-2 bg-transparent border-gray-700 no-scrollbar scroll-smooth">
            <div className="border-[1px] border-gray-700 bg-black rounded-md p-2">
