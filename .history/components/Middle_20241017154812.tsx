...
export default function Middle({ posts }: { posts: Post[] }) {
    ...
    return (
        <div className="w-[50%] h-[100%] flex flex-col justify-center items-center border-l-[1px] border-r-[1px] border-gray-700">
            ...
            <div className="w-[100%] pt-12 h-[100vh] overflow-y-scroll flex flex-col gap-2  bg-transparent no-scrollbar scroll-smooth">
           {posts.map((post) => (
            <div key={post.id} className="w-[100%] h-fit p-2 bg-transparent flex flex-col gap-1 border-t-[0.5px] border-gray-700">
                ...
                <div className='flex flex-row w-fit gap-14 items-center border-[1px] p-2 border-gray-700 rounded-full'>
