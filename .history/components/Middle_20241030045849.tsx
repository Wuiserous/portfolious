...
export default function Middle() {
    ...
    return (
        <div className="w-[50%] h-[100%] flex flex-col justify-center items-center border-l-[1px] border-r-[1px] border-gray-700">
            ...
            <div className="w-[100%] pt-[41.5px] h-[100vh] overflow-y-scroll flex flex-col gap-2  bg-transparent no-scrollbar scroll-smooth">
           
            <div className="w-[100%] h-fit pt-4 pl-4 pr-4 v bg-transparent flex flex-col gap-1 border-t-[0.5px] border-gray-700">
                <div className='w-[100%] gap-1 h-fit flex flex-row'>
                    <div className='w-[40px] h-[40px] rounded-full'>
                    {session?.user?(
                    <img
                        src={session.user.image || "/public/image.png"} // Fallback to default image
                        alt="User Profile Image"
                        className="rounded-full"
                    />    
                ):(<img src="/path/to/default/image.png" alt="User Profile Image" className="rounded-full w-16 h-16" />)}
                    </div>
