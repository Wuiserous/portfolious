    ...
    return (
        <div className="w-[50%] h-[100%] flex flex-col justify-center items-center border-l-[1px] border-r-[1px] border-gray-700">
            <div className={`flex sticky top-0 w-full h-fit justify-between items-center border-l-[1px] border-r-[1px] border-gray-700 bg-transparent ${styles.navBar}`}>
                ...
                >
                    <span 
                        className={`inline-block border-b-2 transition-all duration-300 ease-in-out ${activeTab === 'All' ? 'border-orange-500' : 'border-transparent'}`}
                    >
                        All
                    </span>
                </button>
                ...
                >
                    <span 
                        className={`inline-block border-b-2 transition-all duration-300 ease-in-out ${activeTab === 'Following' ? 'border-orange-500' : 'border-transparent'}`}
                    >
                        Following
                    </span>
                </button>
                ...
                >
                    <span 
                        className={`inline-block border-b-2 transition-all duration-300 ease-in-out ${activeTab === 'Jobs' ? 'border-orange-500' : 'border-transparent'}`}
                    >
                        Jobs
                    </span>
                </button>
                ...
                >
                    <span 
                        className={`inline-block border-b-2 transition-all duration-300 ease-in-out ${activeTab === 'Projects' ? 'border-orange-500' : 'border-transparent'}`}
                    >
                        Projects
                    </span>
                </button>
