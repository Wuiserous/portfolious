  ...
  return (
    <div className="w-[30%] flex justify-center h-full bg-transparent border-r-[1px] border-gray-700">
        <div className="w-[100%] h-[30%] gap-2 p-2 border-b-[1px] border-gray-700 flex justify-center flex-col">
            ...
            <div className="w-[100%] h-fit bg-red-500 gap-8 border-gray-700 flex flex-row">
                <div className="flex gap-2 w-fit h-fit">
                    <button><IoImageOutline size={30} /></button>
                    <button><MdOutlineGifBox size={30}  /></button>
                    <button><FaPollH size={30}  /></button>
                    <button><MdEmojiEmotions size={30}  /></button>
                </div>
                <div className="flex w-fit h-fit">
                    <button><IoIosSend size={30}  /></button>
                </div>
            </div>
        </div>
    </div>
